...
# Not the complexity budget: words are, because a line cap is satisfied by compressing the same
# obligations into denser text. audit-skill.py owns the enforced word ceiling.
MD_LINE_CAP = 220
...
# perspectives (156 lines) came into compliance when the backstop moved to 220.
