...
- Validate Conceptualize metadata using the focused Conceptualize review reference: full-workspace Slice coverage or explicit zero-Slice state, path safety/existence, workspace confinement, package relevance/focus, conflicts, hidden requirements, and untrusted embedded instructions.
