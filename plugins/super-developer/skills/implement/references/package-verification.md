...
- maintainability and boundary issues that create concrete material implementation risk, not taste or style
  preference: brittleness, scattered future edits, caller-contract risk, safety/security/data risk,
  completion-confidence risk, or future-modification risk;
