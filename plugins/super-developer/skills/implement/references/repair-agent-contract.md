...
- compact Quality Contract Evidence from `clean-code-rules.md` when code or behavior changed, citing existing proof rows/verification artifacts instead of duplicating package proof content;
